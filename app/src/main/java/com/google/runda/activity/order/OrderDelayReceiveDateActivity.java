...
public class OrderDelayReceiveDateActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lilaBack.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				OrderDelayReceiveDateActivity.this.finish();
			}
		});
		...
		btnEnsureChange.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new com.google.runda.bll.Order().beginDelayOrder(finalOrderId,date+":"+time);
				OrderDelayReceiveDateActivity.this.finish();
			}
		});
