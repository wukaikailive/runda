 ...
 */
public class AllDoneOrdersFragment extends ListFragment implements View.OnClickListener,XListView.IXListViewListener{
    ...
    public void onRefresh() {
        new com.google.runda.bll.Order().beginPullUnfinishedOrders();
    }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.btnDetail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("orderId", String.valueOf(order.ID));
...
//todo full
    ...
    public void onEventMainThread(PullOrdersSucceedEvent event){
        orders= (ArrayList<Order>) event.getData();
